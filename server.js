...
mongodb.connect(// mongo db ichida connec nomli mehod bor va u 3 a paramer oladi 1) Sring 2)
    ...
    (err, client) => {// 3- parametr bu callBack boladi
        try{ //2 - qadam
            ...
            const app = require("./views/app");//client mongoDB ga ulangach app.js ga boglanadi va portga uzatadi
